...
from app.schemas.hilo_import import DirectImportRequest, HiloImportResponse
from app.services.import_service import ImportService

router = APIRouter(prefix="/api/imports", tags=["imports"])


@router.post("/hilo", response_model=HiloImportResponse)
...
@router.post("/measurements", response_model=HiloImportResponse)
async def import_measurements(
    payload: DirectImportRequest,
    import_service: ImportService = Depends(get_import_service),
) -> HiloImportResponse:
    return import_service.import_measurements(payload)
